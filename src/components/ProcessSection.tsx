...
export default function ProcessSection() {
  return (
    <section id="prozess" className="py-20 md:py-32 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="section-title mb-6">
            Ihr Weg zur Immobilie auf Phuket
          </h2>
          <p className="section-subtitle">
            Transparenter 8-Schritte-Prozess von der ersten Beratung bis zur 
            laufenden Verwaltung. Der gesamte Ablauf kann remote erfolgen.
          </p>
        </div>
                        ...
                        <div className="flex-1">
                          ...
                          {step.documents && (
                            <div className="flex items-start gap-2 text-sm text-slate-500 bg-slate-50 rounded-lg p-3">
                              ...
                              <span><strong>Dokumente:</strong> {step.documents}</span>
                            </div>
                          )}
                        </div>
                      </div>
        ...
        <div className="mt-16 bg-brand-600 rounded-2xl p-8 text-white">
          <h3 className="font-display text-2xl mb-4">
            Dokumente vor der Reservierung
          </h3>
          <p className="text-brand-100 mb-6">
            Folgende Unterlagen erhalten Sie vor jeder Reservierungsentscheidung:
          </p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              'Detailliertes Exposé mit Grundrissen',
              'Aktuelle Preisliste des Entwicklers',
              'Muster-Kaufvertrag zur Prüfung',
              'Entwickler-Profil und Referenzen',
            ].map((doc, index) => (

...
// Format EUR with comma thousands separator (required format: €XX,XXX / €X.X Mio.)
...
export function formatCompletion(completion: string | null): string {
  if (!completion) return 'Sofort verfügbar';
...
export function getCategoryLabel(category: string): string {
  switch (category) {
    ...
    case '2026':
      return 'Fertigstellung 2026';
    case '2027':
      return 'Fertigstellung 2027';
    default:
      return category;
  }
}
